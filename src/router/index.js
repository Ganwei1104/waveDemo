...
export const constantRoutes = [{
    ...
    },
    {
        ...
        children: [{
            ...
            name: 'Dashboard',
            meta: { title: 'Dashboard', icon: 'dashboard', affix: true, first: 'da' }
        }]
    },
    {
        path: '/documentation',
        ...
        children: [{
            ...
            name: 'Documentation',
            meta: { title: 'Documentation', icon: 'documentation', affix: true, first: 'do' }
        }]
    },
    {
        path: '/guide',
        ...
        children: [{
            ...
            name: 'Guide',
            meta: { title: 'Guide', icon: 'guide', noCache: true, first: 'gu' }
        }]
    },
    {
        path: '/profile',
        ...
        children: [{
            ...
            name: 'Profile',
            meta: { title: 'Profile', icon: 'user', noCache: true, first: 'pro' }
        }]
    }
]
...
export const asyncRoutes = [{
...

    {
        ...
        children: [{
            ...
            name: 'Icons',
            meta: { title: 'Icons', icon: 'icon', noCache: true, first: 'icon', }
        }]
    },
    ...
    },
    {
        ...
        children: [{
            path: 'index',
            component: () =>
                import ('@/views/provide/index'),
            name: '组件传值',
            meta: { title: '组件传值', icon: 'tab', first: 'Pro' }
        }]
    },
    {
        path: '/tab',
        ...
        children: [{
            ...
            name: 'Tab',
            meta: { title: 'Tab', icon: 'tab', first: 'Tab' }
        }]
    },
...

    {
        ...
        alwaysShow: true,
        name: 'Zip',
        meta: { title: 'Zip', icon: 'zip', first: 'zip' },
        children: [{
            path: 'download',
            component: () =>
...

    {
        ...
        children: [{
            ...
            name: 'PDF',
            meta: { title: 'PDF', icon: 'pdf', first: 'pdf' }
        }]
    },
    {
        path: '/pdf/download',
